...
@testset "Fluxo Vertice" begin
    ...
    v1 = BacenDRM.FluxoVertice(1, 100_000.0, 0_000.0)
    @test v1.cod_vertice == Symbol("01")
    @test v1.valor_alocado == 100_000.0
    @test v1.valor_mam == 0_000.0

    v12 = BacenDRM.FluxoVertice(12, 200_000.0, 20_000.0)
    ...
    # valor mam invalido
    @test_throws AssertionError BacenDRM.FluxoVertice(2, 200_000.0, 20_000.0)
